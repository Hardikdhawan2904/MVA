...
#### Parameters:
*   `GROQ_API_KEY` *(root `.env`)*: Your private Groq Cloud developer token (obtain one from the [Groq Console](https://console.groq.com/keys)). Used for every column-description/classification LLM call.
