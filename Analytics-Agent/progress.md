...
| `tools/explanation_tool.py` | `app/services/explanation_tool.py` | **LLM Narrator** | Sends structured mathematical results (JSON) to Groq's Llama 3.3 model to write a business-ready executive explanation. |
