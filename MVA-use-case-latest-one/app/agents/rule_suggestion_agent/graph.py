...
def build_rule_suggestion_graph(llm_model: str, api_key: str, col_profiles: list, df, existing_rule_keys: list[str]):
    ...
    nodes = RuleSuggestionAgentNodes(llm_model, api_key, col_profiles, df, existing_rule_keys)
...
def run_rule_suggestion_agent(
    ...
    compiled = build_rule_suggestion_graph(llm_model, api_key, col_profiles, df, existing_rule_keys)
