...
- Domain auto-derivation only forwards Agent 1's classification as-is; it doesn't attempt to map Agent 1's broader vocabulary (14+ possible domain names) onto Agent 2's 5 supported domains beyond an exact string match
